...
export default defineConfig({
  ...
  themeConfig: {
    ...
    //编辑本页
    editLink: {
      pattern: 'https://github.com/jacksonhe04/jacksonhe04.github.io/edit/main/docs/:path', // 改成自己的仓库
      text: '在GitHub编辑本页'
    },
    ...
    //社交链接
    socialLinks: [
      { icon: 'github', link: 'https://github.com/jacksonhe04' },
      { icon: 'twitter', link: 'https://yuque.com/jacksonhe' },
      { icon: 'discord', link: 'https://jacksonhe04c@gmail.com/' },
      {
        icon: {
    ...
    footer: {
      ...
      copyright: `Copyright © 2024-${new Date().getFullYear()} <a href="https://github.com/jacksonhe04" target="_blank">JacksonHe04</a>`,
    },
